...
do
	...
	function utility:Pop(object, shrink)
		...
		utility:Tween(clone, {Size = object.Size}, 0)
...
function library:DestroyUI()
	...
	function library:Notify(title, text, callback)
		...
		utility:Tween(notification, {Size = UDim2.new(0, textSize.X + 70, 0, 60)}, 0)
		wait()
		...
		local close = function()
			...
			utility:Tween(notification.Flash, {Size = UDim2.new(1, 0, 1, 0)}, 0)
	...
	function section:addColorPicker(title, default, callback)
		...
		color.MouseButton1Down:Connect(function()
			...
			while draggingColor do
				...
				self:updateColorPicker(colorpicker, nil, {hue, sat, brightness}) -- roblox is literally retarded
				utility:Tween(tab.Container.Color.Select, {Position = UDim2.new(x, 0, 0, 0)}, 0) -- overwrite
	...
	function section:addSlider(title, default, min, max, callback)
		...
		slider.MouseButton1Down:Connect(function(input)
			...
			while dragging do
				utility:Tween(circle, {ImageTransparency = 0}, 0)
			...
			wait(0.5)
			utility:Tween(circle, {ImageTransparency = 1}, 0)
		end)
		...
		if toggle then
			...
			if sectionsRequired < 0 then -- "hides" some sections
				for i = existingSections, #page.sections + 1, -1 do
					...
					utility:Tween(section, {ImageTransparency = 1}, 0)
				end
			end
			...
			if sectionsRequired > 0 then -- "creates" more section
				for i = existingSections + 1, #page.sections do
					...
					utility:Tween(section, {ImageTransparency = 0}, 0)
				end
			end
			...
			for i, section in pairs(page.sections) do
				...
				utility:Tween(section.container.Title, {TextTransparency = 0}, 0)
				section:Resize(true)
			...
			-- sections
			for i, section in pairs(page.sections) do	
				utility:Tween(section.container.Parent, {Size = UDim2.new(1, -10, 0, 28)}, 0)
				utility:Tween(section.container.Title, {TextTransparency = 1}, 0)
			end
	...
	function page:Resize(scroll)
		...
		if scroll then
			utility:Tween(self.container, {CanvasPosition = Vector2.new(0, self.lastPosition or 0)}, 0)
		end
	end
	...
	function section:Resize(smooth)
		...
		if smooth then
			utility:Tween(self.container.Parent, {Size = UDim2.new(1, -10, 0, size)}, 0)
		else
	...
	function section:updateColorPicker(colorpicker, title, color)
		...
		utility:Tween(colorpicker.Button, {ImageColor3 = color3}, 0)
		utility:Tween(tab.Container.Color.Select, {Position = UDim2.new(hue, 0, 0, 0)}, 0)
		
		utility:Tween(tab.Container.Canvas, {ImageColor3 = Color3.fromHSV(hue, 1, 1)}, 0)
		utility:Tween(tab.Container.Canvas.Cursor, {Position = UDim2.new(sat, 0, 1 - brightness)}, 0)
	...
	function section:updateSlider(slider, title, value, min, max, lvalue)
		...
		utility:Tween(bar.Fill, {Size = UDim2.new(percent, 0, 1, 0)}, 0)
	...
	function section:updateDropdown(dropdown, title, list, callback)
		...
		utility:Tween(dropdown, {Size = UDim2.new(1, 0, 0, (entries == 0 and 30) or math.clamp(entries, 0, 3) * 34 + 38)}, 0)
		utility:Tween(dropdown.Search.Button, {Rotation = list and 180 or 0}, 0)
