	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Button(text,callback)
				...
				Button.TextColor3 = Color3.fromRGB(145, 255, 255)
			...
			function ChannelContent:Toggle(text,default,callback)
				...
				ToggleTitle.TextColor3 = Color3.fromRGB(255, 255, 61)
...
function MaouLib:DestroyUI()
	   if pcall(function() return game.CoreGui[LibName] end) then
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				SliderTitle.TextColor3 = Color3.fromRGB(61, 236, 255)
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				DropdownTitle.TextColor3 = Color3.fromRGB(174, 255, 0)
			...
			function ChannelContent:Colorpicker(text, preset, callback)
				...
				ColorpickerTitle.TextColor3 = Color3.fromRGB(255, 132, 0)
			...
			function ChannelContent:Textbox(text, placetext, disapper, callback)
				...
				TextboxTitle.TextColor3 = Color3.fromRGB(255, 132, 0)
			...
			function ChannelContent:Label(text)
				...
				LabelTitle.TextColor3 = Color3.fromRGB(255, 138, 239)
			...
			function ChannelContent:Bind(text, presetbind, callback)
				...
				KeybindTitle.TextColor3 = Color3.fromRGB(89, 153, 255)
				...
				KeybindText.TextColor3 = Color3.fromRGB(69, 140, 72)
