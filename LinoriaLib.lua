...
do
	...
	function Funcs:AddRDropdown(Idx, Info)
...
function Dropdown:UpdateDropdown(newtable)
            ...
            for Value,Idx in next, Values do
                local Table = {};
